@extends('mahasiswas.layout')
    ...
    <div class="form-group">
        ...
        <input type="Jurusan" name="Email" class="formcontrol" id="Email" value="{{ $mahasiswas->Email }}" ariadescribedby="Email" >
        </div>
        <div class="form-group">
        <label for="Tanggal_Lahir">Tanggal_Lahir</label>
        <input type="Tanggal_Lahir" name="Tanggal_Lahir" class="formcontrol" id="Tanggal_Lahir" value="{{ $mahasiswas->Tanggal_Lahir }}" ariadescribedby="Tanggal_Lahir" >
        </div>
